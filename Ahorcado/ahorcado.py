import random, funciones_ahorcado
...
while lives != 0 or hidden_word != word:
    ...
    is_in_word = funciones_ahorcado.letter_in_word(word, letter)
    if is_in_word:
        hidden_word = funciones_ahorcado.assemble_word(word,letter,aux_hidden_word) 
    else:
        lives -= 1
