from TrabajoPractico5 import valid_dni, long_word, id_club, is_multiple_of, average_temperature, extra_space, min_max_num, area_perimeter_circumference, login, buy_discount, list_reciever, dictionary_words_and_length, vector_module, is_prime_num, factorial, digit_in_number, digit_sum
import pytest
# ejemplo prueba
# def test_valid_dni():
